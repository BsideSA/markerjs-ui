...
export class StrokeToolboxPanel extends ToolboxPanel {
  ...
  private getStrokeStyleVisual(strokeDasharray: string): string {
    return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="butt" stroke-linejoin="round"><path stroke-dasharray="${strokeDasharray}" d="M2,12 H22" /></svg>`;
  }
